...
if ($result->num_rows > 0) {
	...
	echo "<table><tr><th>Position</th><th>Team Name</th><th>Games Played</th><th>Games Won</th><th>Games Lost</th><th>Games Drawn</th><th>Goals Scored</th><th>Goals Against</th><th>Points</th></tr>";
	$c=0;
    while($row = $result->fetch_assoc()) {
	   ...
	   {
		   echo "<tr class='even'>";
		echo "<td>".$row["position"]."</td><td><form method='post' action='t.php'><input type='submit' name='f' value="."'".$row["team_name"]."'></input></form></td><td>".$row["games_played"]."</td><td>".$row["won"]."</td><td>".$row["losses"]."</td><td>".$row["draw"]."</td><td>".$row["goals_scored"].
