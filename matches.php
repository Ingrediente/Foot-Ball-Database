...
if ($result->num_rows > 0) {
	...
	<th><form method='post' action='t.php'><input type='submit' value='team1'></input></form></th>
	<th><form method='post' action='t.php'><input type='submit' value='team2'></input></form></th>
	<th><form method='post' action='t.php'><input type='submit' value='result'></input></form></th>
	<th><form method='post' action='stadium.php'><input type='submit' value='Stadium Name'></input></form>
	</th></tr>";
