...
if ($result->num_rows > 0) {
	...
	echo "<table><tr><th>Jersey No</th><th>Name</th><th>Team Name</th><th>Salary</th><th>Age</th><th>Country</th><th>Position</th></tr>";
	$c=0;
    while($row = $result->fetch_assoc()) {
	   ...
	   {
		   echo "<tr class='even'>";
		echo "<td>".$row["player_id"]."</td><td>".$row["fname"]." ".$row["lname"]."</td>"."
		<td><form method='post' action='t.php'><input type='submit' name='f' value="."'".$row["team_name"]."'></input></form></td>
		<td>".$row["salary"]."</td><td>".$row["age"]."</td>
