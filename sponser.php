...
//$str="'".$str."'";
$sql = "SELECT s_name,team FROM sponser_team,sponser WHERE sponser_team.sponser=sponser_id";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // output data of each row
	echo "<p align='center'>Sponsors</p>";
	echo "<table><tr>
    ...
    while($row = $result->fetch_assoc()) {
	   ...
	   {
		   echo "<tr class='even'>";
			echo "<td>".$row["s_name"]."</td><td><form method='post' action='t.php'><input type='submit' name='f' value="."'".$row["team"]."'></input></form></td></tr>";
	   }
	   else
	   {
		    echo "<tr>";
