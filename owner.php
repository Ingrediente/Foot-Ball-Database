...
if ($result->num_rows > 0) {
	...
	echo "<table><tr><th>Owner Id</th><th>Name</th><th>Team Name</th></tr>";
	$c=0;
    while($row = $result->fetch_assoc()) {
	   ...
	   {
		   echo "<tr class='even'>";
		echo "<td>".$row["owner_id"]."</td><td>".$row["owner_fname"]." ".$row["owner_lname"]."</td><td><form method='post' action='t.php'><input type='submit' name='f' value="."'".$row["team_name"]."'></input></form></td></tr>";
		//echo "</table>";	   
	   }
	   else
	   {
