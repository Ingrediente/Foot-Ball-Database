...
if ($result->num_rows > 0) {
	...
	echo "<p align='center'>Managers</p>";
	echo "<table><tr><th>Manager Id</th><th>Name</th><th>Country</th><th>Age</th><th>Salary</th><th>Team name</th>";
	$c=0;
    while($row = $result->fetch_assoc()) {
	   ...
	   {
		   echo "<tr class='even'>";
			echo "<td>".$row["manager_id"]."</td><td>".$row["fname"]." ".$row["lname"]."</td><td>".$row["country"]."</td><td>".$row["age"]."</td><td>".$row["salary"]."</td><td><form method='post' action='t.php'><input type='submit' name='f' value="."'".$row["team_name"]."'></input></form></td></tr>";
		   }
		   else
		   {
			   echo "<tr>";
